...
def calculate_metrics(graph):
    ...
    print(f"Knoten mit höchster Grad-Zentralität: {max_degree_centrality_node[0]} (Zentralität: "
          f"{max_degree_centrality_node[1]:.2f})")
    ...
    print(f"Knoten mit höchster Betweenness-Zentralität: {max_betweenness_centrality_node[0]} (Zentralität: "
          f"{max_betweenness_centrality_node[1]:.2f})")
    ...
    print(f"Knoten mit höchster Eigenvektor-Zentralität: {max_eigenvector_centrality_node[0]} (Zentralität: "
          f"{max_eigenvector_centrality_node[1]:.2f})")
...
def plot_metrics(degree_distribution, degree_centrality, betweenness_centrality, eigenvector_centrality, graph):
    ...
    output_dir = os.path.join(os.path.dirname(__file__), "visualisierungen_personen2")
    ...
    node_colors = ['lightblue' if degree_centrality[node] < max(degree_centrality.values()) * 0.75 else 'red' for
                   node in graph.nodes()]
...
# Hauptfunktion
def main():
    file_name = "Personen_ohneNeuffen.graphml"
